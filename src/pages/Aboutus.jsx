    ...
    <>
      ...
      <section className="bg-[#FEE9B1]">
        <div className="flex flex-col justify-between max-w-7xl mx-auto pb-40 md:pb-20 px-6">
          <div className="text-center">Nav bar goes here</div>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-base p-3 md:text-base mt-3">
              At AMP Gate Nigeria, we are passionate about delivering reliable,
          ...
          <div className="relative mt-16">
            ...
            <div className="flex justify-between absolute mt-6 md:mt-0 md:bottom-60 w-full md:text-[#ffffff]">
              ...
              <div className="bg-[#ffffff] text-[#161616] md:absolute md:-right-10 p-2  px-6 h-fit flex justify-center items-center gap-2 rounded-3xl">
      ...
      <section className="grid md:grid-cols-2 gap-20 py-14 max-w-7xl mx-auto px-6">
        <div>
          ...
          <p className="leading-9 mt-8">
            ...
            company better serve our clients which include oil and gas, utility,
            IPP, industrial and commercial segments of the economy.
          </p>
        </div>
        <div>
          <img
      ...
      <section className="grid md:grid-cols-2 gap-20 py-14 max-w-7xl mx-auto px-6">
        ...
        <div>
          ...
          <p className="leading-9 mt-8">
            ...
            from generator, load bank, logistic, engineering, project management
            and general power equipment rentals and sales and provision of
            maintenance services. With our unwavering commitment to customer
            satisfaction and a wide range of top-quality power solutions, we
            have established ourselves as a trusted partner for businesses and
            individuals in need of reliable and efficient power systems.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:place-items-center lg:grid-cols-4 gap-6 mt-10">
          ...
          <div className="border md:max-w-[280px] text-center p-4 rounded-xl">
            ...
            <p className="text-[#464646] font-thin text-lg ">
              We build lasting relationships by offering personalized attention,
              quick responses, and professional support every step of the way
            </p>
          </div>
          {/* ====== Card Two ====== */}
          ...
          <div className="border md:max-w-[280px] text-center p-4 rounded-xl">
            <div className="w-10 h-10 bg-black rounded-full mx-auto"></div>
            <p className="font-semibold my-4">Flexibility and Customization</p>
            <p className="text-[#464646] font-thin text-lg">
              We tailor our services to your unique power needs, working closely
              with you to provide solutions that fit your goals and budget
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="relative mt-16 rounded-3xl">
          ...
          <p className="absolute inset-0 bg-black bg-opacity-70 text-lg flex items-center text-[#ffffff] font-medium p-4 text-center rounded-xl leading-8  md:px-20">
            At Ampgate, we believe that our team is our greatest asset. Our team
            of experienced and knowledgeable professionals is dedicated to
            providing our customers with the highest quality power solutions and
            services. Our team members come from a variety of backgrounds,
            including engineering, project management, and logistics. This
            diversity of experience allows us to provide our customers with a
            comprehensive range of services, from designing and implementing
            power systems to transporting and maintaining equipment. We are
            committed to providing our team members with the training and
            resources they need to be successful. We also encourage our team
            members to collaborate and share knowledge, so that we can provide
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <div className="mt-10 grid lg:grid-cols-3 place-items-center">
          {/* ==== CEO CARD === */}
